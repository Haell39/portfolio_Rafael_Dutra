export const translations = {
  pt: {
    ...
    about: {
      kicker: "• SOBRE MIM •",
      title: "Não vendo dashboards.",
      subtitle_highlight: "Entrego insights acionáveis.",
  ...
  en: {
    ...
    about: {
      kicker: "• ABOUT ME •",
      title: "I don't sell dashboards.",
      subtitle_highlight: "I deliver actionable insights.",
  ...
  es: {
    ...
    about: {
      kicker: "• SOBRE MÍ •",
      title: "No vendo dashboards.",
      subtitle_highlight: "Entrego insights accionables.",
    ...
    contact: {
      ...
      subtitle:
        "Estoy disponible para proyectos freelance y nuevas oportunidades. Si tienes un proyecto en mente o solo quieres saludar, no dudes en contactarme.",
      cta: "Contactar",
